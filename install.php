...
if (!$is_installed) {
    if (!array_key_exists("base_de_datos", $_POST)) {
        include("./installer.php");
        die();
    }
    if (!array_key_exists("autentificador", $_POST)) {
        include("./installer.php");
        die();
    }
    if (!array_key_exists("estructura", $_POST)) {
        include("./installer.php");
        die();
    }
    if (!array_key_exists("migracion", $_POST)) {
        include("./installer.php");
        die();
    }
    $database = null;
        ...
        <form action="install.php" method="POST">
            ...
            <div style="padding:4px; font-size: 11px;">
                ...
                <ul style="padding-left: 20px;">
                    ...
                    <li>They must contain the parameter «operation» with «schema», «select», «insert», «update» or
                        «delete».</li>
                ...
                <div>
                    ...
                    <ul style="padding-left: 20px;">
                        <li>In the case of the SCHEMA, there is nothing you can do: it will simply return all the tables
                            available in the database, with their columns and other attributes.</li>
                        <li>In the case of the SELECT, there is nothing you can do: it will simply return all the
                            records of the table we specify.</li>
                        <li>In the case of the INSERT, there is 1 added parameter: «value» that must be an object with
                            the values to insert.</li>
                        <li>In the case of the UPDATE, there are 2 added parameters: «value» that must be an object with
                            the values to update, and «id» that must be an integer with the ID of the record to update.
                        </li>
                        <li>In the case of the DELETE, there is 1 added parameter: «id» that must be an integer with the
                            ID of the record to delete.</li>
                    </ul>
                </div>
